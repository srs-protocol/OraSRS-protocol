...
// SecurityRiskAssessmentContract OraSRS 质押合约
...
func (c *SecurityRiskAssessmentContract) SubmitChallenge() error {
	ctx := contract.GetContext()
...
func (c *SecurityRiskAssessmentContract) UpdateReputation() error {
	ctx := contract.GetContext()
...
// SlashNode 节点罚没
func (c *SecurityRiskAssessmentContract) SlashNode() error {
	ctx := contract.GetContext()
...
func (c *SecurityRiskAssessmentContract) RequestWithdrawal() error {
	ctx := contract.GetContext()
...
// AddValidator 添加验证器
func (c *SecurityRiskAssessmentContract) AddValidator() error {
	ctx := contract.GetContext()
...
func (c *SecurityRiskAssessmentContract) PauseContract() error {
	ctx := contract.GetContext()
...
func (c *SecurityRiskAssessmentContract) ResumeContract() error {
	ctx := contract.GetContext()
