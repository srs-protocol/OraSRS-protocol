// OraSRSNetwork.mjs - ES Module version
import { OraP2PNode } from './OraP2PNode.mjs';
import { ethers } from 'ethers';

export class OraSRSNetwork {
  constructor() {
  ...
  setupSubscriptions() {
    // 确保节点已启动后再订阅
    if (this.p2pNode.node && this.p2pNode.node.pubsub) {
      // 全局威胁情报频道
