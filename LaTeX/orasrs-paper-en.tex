...
In recent years, blockchain technology applications in the security field have increased. Through blockchain's immutability and decentralization characteristics, credible threat intelligence sharing networks can be built. For example, the BTCRelay project demonstrated the potential of blockchain as a decentralized oracle, providing external data access for on-chain contracts. Morello et al. proposed a blockchain-based threat intelligence sharing framework utilizing smart contracts for automated intelligence verification and distribution. However, existing solutions still have challenges in performance, privacy protection, and scalability.
...
\begin{theorem}[Nash Equilibrium Theorem]
